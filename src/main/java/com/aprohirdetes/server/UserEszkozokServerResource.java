...
public class UserEszkozokServerResource extends ServerResource implements
		FormResource {
	...
	public Representation representHtml() throws IOException {
		...
		appDataModel.put("htmlTitle", getApplication().getName() + " - Eszközök");
		appDataModel.put("description", "Regisztrált felhasználó beállításainak szerkesztése.");
